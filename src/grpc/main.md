...
- **Source**:
  [cade_api.proto](https://github.com/librematch/delta-play-replay/blob/main/crates/uncage-client/proto/cade_api.proto)
...
Returns game version, API version, base directory, and enabled
mod directories.
...
Changes the player perspective (which player's point of view
is shown).
...
Configures the frame stream. Resolution entries control how
often different categories of data are sent.
